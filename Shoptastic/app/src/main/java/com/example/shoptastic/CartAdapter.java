...
public class CartAdapter extends CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        // getting theviews
        TextView drinkName, yesGift, yesTopping, price, quantity;

        drinkName = view.findViewById(R.id.itemNameinOrderSummary);
        price = view.findViewById(R.id.priceinOrderSummary);
        yesGift = view.findViewById(R.id.hasGift);
