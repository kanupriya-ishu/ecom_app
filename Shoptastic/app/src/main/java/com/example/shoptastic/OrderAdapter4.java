...
public class OrderAdapter4 extends RecyclerView.Adapter<OrderAdapter4.ViewHolder> {

    List<Model> modelList;
    Context context;

    public OrderAdapter4(Context context, List<Model> modelList) {
        this.context = context;
        this.modelList = modelList;
    }

    @Override
    public OrderAdapter4.ViewHolder onCreateViewHolder(ViewGroup parent, int i) {

        View view = LayoutInflater.from(context).inflate(R.layout.listitem, parent, false);
        return new OrderAdapter4.ViewHolder(view);

    }

    @Override
    public void onBindViewHolder(OrderAdapter4.ViewHolder holder, int position) {
